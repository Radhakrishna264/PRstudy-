      ...
      <div className="max-w-xl w-full text-center relative">
        ...
        <div className="relative flex justify-center mb-6">
          <div className="h-20 w-20 rounded-2xl bg-[#0b0f1a] border border-white/10 flex items-center justify-center
            ...
            <span className="text-3xl font-bold tracking-wide bg-gradient-to-br from-indigo-400 to-cyan-400 bg-clip-text text-transparent">
              PR
            </span>
          </div>
        </div>
        ...
        {/* BRAND NAME */}
        <h1 className="relative text-4xl sm:text-5xl font-extrabold mb-4
